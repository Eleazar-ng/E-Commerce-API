...
export const passwordResetEmail = (firstName:string, code:string) => {
return `
	<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <div class="row">
              ...
              <div class="col-xl-6 col-lg-6">
                  <div class="__bg-w">
                      <div class="__hedimg">
                          <img src="cid:logo" class="__logo" />
                          <p class="__capt">Password Reset</p>
                      </div>
                      <div class="__conth">
                          <p class="__nam">Hi ${firstName}</p>
                          <p class="__nam-sub">To reset your password, enter the OTP below:</p>
